const linkColumns = [
  {
    title: "PRODUCT",
    links: ["Features", "Platforms", "Pricing", "Changelog"],
  },
  {
    title: "DEVELOPERS",
    links: ["Documentation", "API Reference", "Plugin SDK", "Examples"],
  },
  {
    title: "COMPANY",
    ...
    <footer className="relative border-t border-card-border">
      <div className="max-w-container mx-auto px-6 pt-24 pb-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-12 mb-20">
          {linkColumns.map((col) => (
            <div key={col.title}>
              <p className="text-ui text-accent text-[10px] mb-4">
                {col.title}
              </p>
              <ul className="space-y-3">
                {col.links.map((link) => (
                  <li key={link}>
                    <a
                      href="#"
                      className="text-ui text-muted text-[11px] hover:text-white transition-colors"
                    >
                      {link}
                    </a>
                  </li>
        ...
        <div className="flex justify-center gap-6 mb-12">
          ...
          {/* Discord */}
          <a href="#" className="text-muted hover:text-accent transition-colors" aria-label="Discord">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
